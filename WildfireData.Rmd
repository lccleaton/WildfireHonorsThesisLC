...
ggplot(evac_timeline_full, aes(x = diff_hours, fill = region)) +
  ...
  labs(
    title = "Evacuation Duration Distribution",
    subtitile = "In the United States",
    x = "Evacuation Duration (hrs)",
...
ggplot(evac_summary, aes(x = affected_population, y = Zone_Label, fill = duration_hours)) +
  geom_col() +
  scale_fill_gradient(low = "lightblue", high = "darkblue", name = "Total Duration (hrs)") +
  scale_x_continuous(labels = comma) +
  labs(
    title = "Population Affected by Zone",
...
ggplot(zone_plot_data, aes(x = econ_disruption_rank, y = Zone_Label, fill = Evacuation_Per_Person)) +
  ...
  scale_x_continuous(labels = comma) +
  labs(
    title = "Economic Disruption Rank by Zone",
    subtitle = "In California",
    x = "Economic Disruption Rank",
    y = "Evacuation Zone"
  ) +
...
ggplot(zone_income_pop, 
  ...
  scale_x_continuous(labels = comma) +
  labs(
    title = "Economic Disruption Across Zones",
    subtitle = "In California",
...
ggplot(zone_plot_poverty,
  ...
  labs(
    title = "ACS 2024 Poverty Rate by Zone",
    subtitle = "In California",
    x = "Poverty Rate",
    y = "Evacuation Zone"
  ) +
